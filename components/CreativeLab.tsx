...
const CreativeLab: React.FC<CreativeLabProps> = ({ onAddToDeck, onDeepDive, cefrLevel, register }) => {
    // Shared state
        ...
        <div className="glass-panel p-6 rounded-2xl shadow-lg">
            ...
            <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <select value={localCefrLevel} onChange={e => setLocalCefrLevel(e.target.value)} className="w-full p-2 border border-slate-300/80 dark:border-slate-600/80 rounded-lg bg-white/60 dark:bg-slate-900/40 focus:ring-2 focus:ring-emerald-500">
                ...
                <div>
                    ...
                    <select value={localRegister} onChange={e => setLocalRegister(e.target.value)} className="w-full p-2 border border-slate-300/80 dark:border-slate-600/80 rounded-lg bg-white/60 dark:bg-slate-900/40 focus:ring-2 focus:ring-emerald-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white/50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200/80 dark:border-slate-700/60 flex flex-col">
                    <div className="font-bold text-lg flex items-center gap-2 mb-3 bg-gradient-to-r from-amber-100 to-white dark:from-amber-900/40 dark:to-slate-800/40 -m-4 p-4 rounded-t-xl border-b border-slate-200/80 dark:border-slate-700/60"><BrainIcon className="w-6 h-6 text-amber-500" /> Esploratore Concettuale</div>
                    <form onSubmit={handleExplorerSubmit} className="flex gap-2">
                        <input type="text" value={explorerConcept} onChange={e => setExplorerConcept(e.target.value)} placeholder="Parola o concetto..." className="w-full p-2 border-slate-300/80 dark:border-slate-600/80 rounded-md bg-white/60 dark:bg-slate-900/40 focus:ring-2 focus:ring-amber-500 text-sm"/>
                ...
                {/* Collocation Suggester */}
                 <div className="bg-white/50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200/80 dark:border-slate-700/60 flex flex-col">
                    <div className="font-bold text-lg flex items-center gap-2 mb-3 bg-gradient-to-r from-sky-100 to-white dark:from-sky-900/40 dark:to-slate-800/40 -m-4 p-4 rounded-t-xl border-b border-slate-200/80 dark:border-slate-700/60"><LightbulbIcon className="w-6 h-6 text-sky-500" /> Suggeritore di Collocazioni</div>
                    <form onSubmit={handleSuggesterSubmit}>
                        <textarea value={suggesterIdea} onChange={e => setSuggesterIdea(e.target.value)} placeholder="Descrivi un'idea o contesto..." className="w-full p-2 border-slate-300/80 dark:border-slate-600/80 rounded-md bg-white/60 dark:bg-slate-900/40 focus:ring-2 focus:ring-sky-500 text-sm" rows={2}/>
                ...
                <div className="bg-white/50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200/80 dark:border-slate-700/60 flex flex-col">
                    <div className="font-bold text-lg flex items-center gap-2 mb-3 bg-gradient-to-r from-emerald-100 to-white dark:from-emerald-900/40 dark:to-slate-800/40 -m-4 p-4 rounded-t-xl border-b border-slate-200/80 dark:border-slate-700/60"><DeckIcon className="w-6 h-6 text-emerald-500" /> Generatore Deck Tematico</div>
                    <form onSubmit={handleDeckSubmit}>
                        <input type="text" value={deckTheme} onChange={e => setDeckTheme(e.target.value)} placeholder="Scrivi un tema..." className="w-full p-2 border-slate-300/80 dark:border-slate-600/80 rounded-md bg-white/60 dark:bg-slate-900/40 focus:ring-2 focus:ring-emerald-500 text-sm"/>
